              ...
              <div className="ui stackable inverted divided grid">
                      ...
                      <div className="eight wide column">
                        ...
                        <div className="sourceLayout" >
                            <p className="sources"style={{marginBottom: '-15px', marginRight: '10px'}}> <a href="#" target="_blank" className="item">County Income Data </a> </p>
                            <p className="sources"style={{marginBottom: '-15px'}}> <a href="#" target="_blank" className="item"> State Income Data </a> </p>
                              <br/>
                        </div>

                      <div className="sourceLayout">
                          <p className="sources"style={{marginBottom: '-15px',  marginRight: '10px'}}>  <a href="#" target="_blank" className="item">County Population Data </a> </p>
                            <br/>
                          <p className="sources" style={{marginBottom: '-35px'}}> <a href="#" target="_blank" className="item">State Population Data</a> </p>
                            <br/>
                        </div>
                      </div>
